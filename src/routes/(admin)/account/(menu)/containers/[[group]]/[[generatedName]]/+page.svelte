<script lang="ts">
  ...
  import StateBadge from '../../statebadge.module.svelte';
...
<div class="navbar bg-base-100">
  <div class="flex-1">
    <a class="btn btn-ghost text-xl" href="/account/containers">Containers</a>
  </div>
  <div class="flex-none">
        ...
        <div class="w-full mt-5 p-10 bg-base-100 flex flex-col items-center justify-center rounded-lg shadow-md">
          <table class="table mt-5">
            ...
            {#each $containerIds as containerId}
              ...
              <tr
                class="border-b-0 { $containersMap[containerId].General.Status.state.state === 'delete' ? 'bg-warning' : '' }">
                                          ...
                                          <table class="table">
                                            ...
                                            <tr>
                                              <td colspan="2" class="max-w-[120px] truncate text-ellipsis">
                                                ...
                                                .{$containersMap[containerId].Platform.GeneratedName}.private
                                              </td>
                                            </tr>
                                            <tr>
                                              <td colspan="2" class="max-w-[120px] truncate text-ellipsis">
                                ...
                                {#each Object.entries(container.General.Runtime.Configuration) as [key, value]}
                                  <div class="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                                    ...
                                    <div class="min-w-[300px] max-w-[500px] w-full">
                                      <input
                                        type="text"
                                        class="input input-bordered w-full bg-base-100 text-base-content opacity-60 cursor-default"
                                        readonly
                                        value="{value}"
                                      >
                                    </div>
