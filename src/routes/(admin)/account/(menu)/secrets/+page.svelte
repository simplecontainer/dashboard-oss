<script lang="ts">
  ...
  import {secretsMap, AddSecret} from "../stores/secrets";
...
<div class="navbar bg-base-100">
  <div class="flex-1">
    <a href="/account/secrets" class="btn btn-ghost text-xl">Secrets</a>
  </div>
  <div class="flex-none">
...
{:else}
  ...
  {#each Object.entries($secretsMap) as [key, resource]}
